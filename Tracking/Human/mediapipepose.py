...
try:
    ...
    print(f"""[  \_  ] Couldn't load core dependencies, try installing them:
...
from utils.backends import DummyBackend, SteamVRBackend, VRChatOSCBackend

import utils.inference_gui
...
def main():
    ...
    params = utils.parameters.Parameters()
    ...
    gui_thread = threading.Thread(target=utils.inference_gui.make_inference_gui, args=(params,), daemon=True)
    gui_thread.start()
